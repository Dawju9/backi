...
<head>
    ...
    <title>WhiteKali presents</title>
...
<body>
    <header>
        <div data-bss-parallax-bg="true" style="height: 600px;background: url(&quot;assets/img/f72a31fac7bdc6d6a9e7f0ebc5ed5899.jpg&quot;) right / contain space;">
            <div class="container d-flex flex-column justify-content-end align-items-start">
                <div class="row">
                    <div class="col"><img class="d-xl-flex flex-column justify-content-xl-start align-items-xl-end" src="assets/img/minka.png" width="230px"></div>
                </div>
                <div class="row">
                    <div class="col"><img src="assets/img/images%20(1).png"></div>
                </div>
                <!-- 
            ...
            <p>Standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>				
              ...
              <script src="assets/js/custom.js"></script>
                ...
                <div class="row">
                    <div class="col">
                        <h1 class="display-3 fw-bold">Good Night</h1>
                        <p>ur fired...</p>
                    </div>
                </div>
            </div>
